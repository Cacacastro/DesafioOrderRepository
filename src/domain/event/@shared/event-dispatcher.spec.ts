...
import SendNotifyWhenCustomerIsCreatedHandler from "../customer/handler/send-notify-when-customer-is-created.handler";
...
import SendNotifyWhenCustomerChangesAddress from "../customer/handler/send-notify-when-address-changes.event";
